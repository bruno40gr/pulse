...
const FIELD_ALIASES: Record<string, string[]> = {
  ...
  email: ['email', 'client_email', 'client email', 'payer_email', 'payer email', 'account_email', 'accountmanager email'],
  phone: ['phone', 'client_phone', 'payer_phone', 'account_phone', 'accountmanager phone'],
  ...
  band_name: ['band_name', 'band name', 'ensemble'],
...
function parseCSVWithMappings(rows: CsvRow[], mappings: FieldMapping[]): ParsedContact[] {
  ...
  for (const row of rows) {
    ...
    contacts.push({
      first_name,
      last_name,
      email: pickValue(row, fieldToColumn, 'email'),
      ...
      band_name: pickValue(row, fieldToColumn, 'band_name'),
